...
""")
    ...
    def check(self, passed_plt):
        ...
        """
        assert len(passed_plt.figure(1).axes[0].get_legend_handles_labels()[0]) == 4, \
        ...
        legend_set = {'america_tropical_interpretive_center', 'firehouse_museum', 'avila_adobe', 'chinese_american_museum'}
        assert set(passed_plt.figure(1).axes[0].get_legend_handles_labels()[1]) == legend_set, \
            ...
            %s.  
            """ \
            % (set(passed_plt.figure(1).axes[0].get_legend_handles_labels()[1]), legend_set)
