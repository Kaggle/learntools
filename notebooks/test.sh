...
TRACKS="deep_learning_intro deep_learning embeddings pandas python machine_learning sql data_viz_to_coder ml_intermediate sql_advanced feature_engineering geospatial nlp game_ai data_cleaning"
...
TESTABLE_NOTEBOOK_TRACKS="deep_learning_intro geospatial python pandas machine_learning data_viz_to_coder ml_intermediate nlp feature_engineering game_ai data_cleaning"
